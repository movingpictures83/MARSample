...
output <- function(outputfile) {
  ...
  par(mar=c(2, 2, 2, 2))
  print("HI")
  print(DEGexp(geneExpMatrix1=geneExpMatrix1, geneCol1=1, expCol1=c(2,3,4,5,6), groupLabel1=group1,
       geneExpMatrix2=geneExpMatrix2, geneCol2=1, expCol2=c(2,3,4,5,6), groupLabel2=group2,
       method="MARS", outputDir=outputfile))
